...
- [ ] Limpieza manual de datos duplicados en BD para cursos ya afectados (ver sección 5)

### CourseEngine (pendiente de revisión)

- [ ] **CRÍTICO:** Verificar que el campo `course.slug` siempre se incluye en el payload y es estable entre publicaciones
...
*Documento generado el 2026-04-20. Contacto técnico SofLIA: pedro.echeverria@pulsehub.mx*
