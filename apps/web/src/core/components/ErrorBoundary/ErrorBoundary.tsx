...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen bg-white dark:bg-carbon-900 flex items-center justify-center px-4" style={{ fontFamily: 'Inter, sans-serif' }}>
          <div className="max-w-md w-full bg-white dark:bg-carbon-800 border border-gray-200 dark:border-gray-500/30 rounded-xl shadow-sm p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-primary dark:text-white mb-2" style={{ fontFamily: 'Inter, sans-serif' }}>
              Algo salió mal
            </h2>

            <p className="text-gray-500 dark:text-white/80 mb-6" style={{ fontFamily: 'Inter, sans-serif' }}>
