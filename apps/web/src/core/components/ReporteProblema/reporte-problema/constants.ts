...
export const categorias: CategoryOption[] = [
  ...
  { value: 'sugerencia', label: 'Sugerencia', icon: Lightbulb, color: 'text-warning dark:text-warning', bgColor: 'bg-amber-50 dark:bg-amber-900/20', borderColor: 'border-warning' },
  { value: 'contenido', label: 'Problema de Contenido', icon: FileText, color: 'text-primary dark:text-accent', bgColor: 'bg-blue-50 dark:bg-blue-900/20', borderColor: 'border-primary dark:border-accent' },
  ...
  { value: 'otro', label: 'Otro', icon: HelpCircle, color: 'text-gray-500 dark:text-gray-500', bgColor: 'bg-gray-50 dark:bg-gray-800/50', borderColor: 'border-gray-500' },
];
