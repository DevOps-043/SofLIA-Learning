export type OrganizationCourseAssignmentsTable = {
  ...
  Relationships: [
    ...
    { foreignKeyName: "organization_course_assignments_default_rule_id_fkey"; columns: ["default_rule_id"]; isOneToOne: false; referencedRelation: "organization_course_default_rules"; referencedColumns: ["id"] },
    ...
    { foreignKeyName: "organization_course_assignments_source_learning_path_id_fkey"; columns: ["source_learning_path_id"]; isOneToOne: false; referencedRelation: "learning_paths"; referencedColumns: ["id"] },
