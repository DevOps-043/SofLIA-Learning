...
export const UI_MOBILE_APP_TEMPLATE: NanoBananaSchema = {
  ...
  scene: { id: 'scene_mobile_app', description: 'Aplicacion movil con navegacion estandar', environment: { lighting: 'ambient', background: '#121212', mood: 'professional', colorScheme: 'dark', primaryColor: '#6366F1', secondaryColor: '#1E1E2E', accentColor: '#22D3EE' }, dimensions: { width: '375px', height: '812px' } },
  entities: [
    ...
    { id: 'nav_header', type: 'component', name: 'Header', properties: { height: '56px', backgroundColor: '#1E1E2E', title: { text: 'App Title', fontSize: '18px', fontWeight: '600', color: '#FFFFFF' }, actions: ['back', 'menu'] }, position: 'top', emphasis: 'primary' },
    { id: 'content_main', type: 'container', name: 'Main Content Area', properties: { flex: 1, padding: '16px', backgroundColor: '#121212', scrollable: true }, position: 'center', emphasis: 'primary', children: [] },
    { id: 'nav_bottom', type: 'component', name: 'Bottom Navigation', properties: { height: '56px', backgroundColor: '#1E1E2E', items: [{ id: 'nav_home', icon: 'home', label: 'Inicio', active: true }, { id: 'nav_search', icon: 'search', label: 'Buscar', active: false }, { id: 'nav_profile', icon: 'user', label: 'Perfil', active: false }] }, position: 'bottom', emphasis: 'primary' },
  ],
...
export const UI_DASHBOARD_TEMPLATE: NanoBananaSchema = {
  ...
  scene: { id: 'scene_dashboard', description: 'Dashboard con sidebar y metricas', environment: { lighting: 'ambient', background: '#0F172A', mood: 'professional', colorScheme: 'dark', primaryColor: '#3B82F6', secondaryColor: '#1E293B', accentColor: '#10B981' }, dimensions: { width: '1440px', height: '900px' } },
  entities: [
    { id: 'sidebar_main', type: 'container', name: 'Sidebar', properties: { width: '280px', backgroundColor: '#1E293B', padding: '24px 16px' }, position: 'left', emphasis: 'secondary', children: [
    ...
    { id: 'content_main', type: 'container', name: 'Main Content', properties: { flex: 1, padding: '32px', backgroundColor: '#0F172A' }, position: 'center', emphasis: 'primary', children: [
...
export const PHOTO_PRODUCT_TEMPLATE: NanoBananaSchema = {
  ...
  scene: { id: 'scene_product_photo', description: 'Fotografia de producto en estudio', environment: { lighting: 'studio-three-point', background: '#FFFFFF', mood: 'clean-professional' } },
  entities: [
    ...
    { id: 'light_key', type: 'light', name: 'Key Light', properties: { type: 'softbox', intensity: 1.0, color: '#FFFFFF', angle: 45, distance: 'medium' }, position: 'top-right', emphasis: 'background' },
    { id: 'light_fill', type: 'light', name: 'Fill Light', properties: { type: 'reflector', intensity: 0.5, color: '#FFFFFF', angle: -30 }, position: 'left', emphasis: 'background' },
    { id: 'light_rim', type: 'light', name: 'Rim Light', properties: { type: 'strip', intensity: 0.7, color: '#FFFFFF', angle: 135 }, position: 'top-left', emphasis: 'background' },
  ],
...
export const DIAGRAM_FLOWCHART_TEMPLATE: NanoBananaSchema = {
  ...
  scene: { id: 'scene_flowchart', description: 'Diagrama de flujo de proceso', environment: { lighting: 'flat', background: '#FFFFFF', mood: 'informative' } },
  entities: [
    { id: 'node_start', type: 'node', name: 'Start', properties: { shape: 'oval', backgroundColor: '#10B981', textColor: '#FFFFFF', text: 'Inicio', width: '120px', height: '60px' }, position: 'top', emphasis: 'primary' },
    { id: 'node_process_1', type: 'node', name: 'Process 1', properties: { shape: 'rectangle', backgroundColor: '#3B82F6', textColor: '#FFFFFF', text: 'Proceso', width: '160px', height: '80px' }, position: 'center', emphasis: 'primary' },
    { id: 'node_decision', type: 'node', name: 'Decision', properties: { shape: 'diamond', backgroundColor: '#F59E0B', textColor: '#FFFFFF', text: 'Condicion?', width: '140px', height: '140px' }, position: 'center', emphasis: 'accent' },
    { id: 'node_end', type: 'node', name: 'End', properties: { shape: 'oval', backgroundColor: '#EF4444', textColor: '#FFFFFF', text: 'Fin', width: '120px', height: '60px' }, position: 'bottom', emphasis: 'primary' },
    { id: 'connector_1', type: 'connector', name: 'Arrow 1', properties: { from: 'node_start', to: 'node_process_1', style: 'arrow', color: '#64748B', strokeWidth: '2px' }, position: 'center', emphasis: 'secondary' },
  ],
