/**
 * VARIANTE GEMINI del turno de moderacion. TEXTO ORIGINAL, CONGELADO.
 *
 * No se toca para mejorar OpenAI: para eso existe `ai-user-prompt.openai.ts`.
 */
import type { AIModerationContext } from './types'

export function buildAIModerationUserPromptForGoogle(
  content: string,
