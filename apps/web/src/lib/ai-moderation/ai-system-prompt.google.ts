/**
 * VARIANTE GEMINI del prompt de moderacion. TEXTO ORIGINAL, CONGELADO.
 *
 * El catalogo de evasiones (leetspeak, abreviaturas, umbrales de confianza) esta
 * ajustado con casos reales. No se toca para mejorar OpenAI: para eso existe
 * `ai-system-prompt.openai.ts`.
 */
export const AI_MODERATION_SYSTEM_PROMPT_GOOGLE = `Eres un moderador de contenido ultra-estricto para una comunidad educativa profesional.
