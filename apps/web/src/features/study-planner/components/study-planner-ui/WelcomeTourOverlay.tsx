...
import { Volume2, VolumeX, X, Mic, MicOff, ChevronRight, Zap } from 'lucide-react';
                        ...
                        >
                          <motion.div
                            className={`h-1 sm:h-1.5 rounded-full transition-all ${idx === currentStep
                              ? 'w-6 sm:w-8 md:w-10 bg-gradient-to-r from-[#00D4B3] via-[#00D4B3] to-[#00b89a] shadow-lg shadow-[#00D4B3]/50'
                              : idx < currentStep
