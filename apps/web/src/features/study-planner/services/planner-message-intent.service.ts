...
const SIMPLE_AFFIRMATIONS = new Set([
  'si',
  'ok',
  'acepto',
  'dale',
...
const SCHEDULE_CONFIRMATION_PHRASES = [
  'me sirven',
  'confirmo',
  'esta bien',
  'de acuerdo',
...
const TARGET_DATE_OBJECTS = ['fecha', 'limite'] as const;
...
function detectSelectedOptionNumber(normalizedMessage: string): number | null {
...
function buildExpandedScheduleAcceptanceMessage(
  message: string,
...
function buildAlternativeSelectionMessage(
  message: string,
  selectedOptionNumber: number | null,
  conversationHistory: StudyPlannerMessage[],
  hasSavedDistribution: boolean,
