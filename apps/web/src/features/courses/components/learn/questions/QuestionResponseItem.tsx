        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1 flex-wrap">
            ...
            {response.is_instructor_answer && (
              <span className="ml-1 px-1.5 py-0.5 bg-primary/10 text-primary dark:bg-accent/20 dark:text-accent text-[10px] font-medium rounded">
                Instructor
              </span>
            )}
          </div>
                ...
                >
                  <div className="flex gap-3">
                    <textarea
                      ...
                      className="flex-1 bg-transparent border-0 border-b border-gray-200 px-0 py-1 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:border-primary/40 dark:focus:border-accent/50 focus:ring-0 resize-none min-h-[32px]"
                      rows={1}
                    />
                    <button
