...
export function buildDarkBrandCss(
  ...
  return `
    ...
    .text-\\[\\var(--color-accent)\\], .text-emerald-500, .text-green-500, .text-green-400,
    ...
    .bg-\\[\\var(--color-accent)\\], .bg-emerald-500, .bg-green-500, .bg-green-400 {
      background-color: ${colors.accent} !important;
    }
    .border-\\[\\var(--color-accent)\\], .border-emerald-500, .border-green-500,
    ...
    .bg-\\[\\var(--color-success)\\]\\/10, .bg-\\[\\var(--color-accent)\\]\\/10 {
      background-color: rgba(${accentRgb}, 0.1) !important;
    }
    ...
    .from-\\[\\var(--color-accent)\\], .from-green-400, .from-emerald-400 {
      --tw-gradient-from: ${colors.accent} !important;
    }
    .to-\\[\\var(--color-accent)\\], .to-green-400, .to-emerald-400 {
      --tw-gradient-to: ${colors.accent} !important;
    }
    .shadow-\\[\\var(--color-accent)\\]\\/25 {
