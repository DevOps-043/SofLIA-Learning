...
type UseNextLessonNavigationParams = Pick<
  UseLessonNavigationParams,
  "currentLesson" | "lessonsActivities" | "markLessonAsCompleted" | "setActiveTab" | "trackUserAction"
> & {
...
export function useNextLessonNavigation({
  ...
  return useCallback(async () => {
    ...
    if (canComplete) openLesson(nextLesson);
  }, [
    cancelPendingValidation,
    currentLesson,
    getNextLesson,
