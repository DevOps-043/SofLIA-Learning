...
export const PROMPT_EXTRACT_MAX = 1_200
export const PROMPT_NOTES_PER_LESSON = 8
export const PROMPT_INPUT_MAX = 60_000
...
export function sortNotesForPriority(notes: LessonNote[]): LessonNote[] {
