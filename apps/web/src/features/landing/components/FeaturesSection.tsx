...
export function FeaturesSection({ title, subtitle, cards }: FeaturesSectionProps) {
  ...
  return (
    <section 
      ref={sectionRef}
      className="py-32 relative features-section bg-white dark:bg-carbon-900"
    >
                ...
                >
                    ...
                    <motion.div
                      ...
                      >
                        {/* Glowing background */}
                        <motion.div
                          className="absolute inset-0 bg-gradient-to-br from-accent/20 to-accent/10 dark:from-accent/30 dark:to-accent/20 rounded-3xl blur-2xl"
                          animate={isHovered ? {
                            scale: [1, 1.3, 1],
                            opacity: [0.5, 0.8, 0.5]
                          } : {}}
                        ...
                        {/* Main icon container */}
                        <div className="relative w-full h-full bg-gradient-to-br from-accent/20 to-accent/10 dark:from-accent/30 dark:to-accent/20 rounded-3xl flex items-center justify-center border-2 border-accent/30 shadow-2xl backdrop-blur-sm">
                      {card.icon ? (
                        <Icon 
                          name={card.icon as IconName} 
                              size="xl" 
                              className="text-accent w-24 h-24 lg:w-32 lg:h-32"
                        />
                      ) : (
                            <div className="w-24 h-24 lg:w-32 lg:h-32 bg-accent/20 rounded-2xl" />
                          )}
                        </div>
