...
export const businessUserDashboardTour: TourConfig = {
  ...
  steps: [
    ...
    { target: '[data-tour-id="business-user-dashboard--hero"]', titleKey: 'tours.businessUserDashboard.hero.title', contentKey: 'tours.businessUserDashboard.hero.content', placement: 'bottom', disableBeacon: true },
    ...
    { target: '[data-tour-id="business-user-dashboard--learning-path-section"]', titleKey: 'tours.businessUserDashboard.learningPath.title', contentKey: 'tours.businessUserDashboard.learningPath.content', placement: 'bottom', disableBeacon: true, optional: true },
    ...
    { target: '[data-tour-id="business-user-dashboard--learning-path-row"]', titleKey: 'tours.businessUserDashboard.courseRail.title', contentKey: 'tours.businessUserDashboard.courseRail.content', placement: 'top', disableBeacon: true, optional: true },
    { target: '[data-tour-id="business-user-dashboard--course-card"]', titleKey: 'tours.businessUserDashboard.courseCard.title', contentKey: 'tours.businessUserDashboard.courseCard.content', placement: 'top', disableBeacon: true, optional: true },
