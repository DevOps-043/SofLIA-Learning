...
export const businessPanelDashboardTour: TourConfig = {
  ...
  autoStart: true,
  steps: [
    { target: '[data-tour-id="business-panel-dashboard--page"]', titleKey: 'tours.businessPanelDashboard.welcome.title', contentKey: 'tours.businessPanelDashboard.welcome.content', placement: 'center', disableBeacon: true },
    ...
    { target: '[data-tour-id="business-panel-dashboard--hero"]', titleKey: 'tours.businessPanelDashboard.hero.title', contentKey: 'tours.businessPanelDashboard.hero.content', placement: 'bottom', disableBeacon: true },
    { target: '[data-tour-id="business-panel-dashboard--stats-grid"]', titleKey: 'tours.businessPanelDashboard.stats.title', contentKey: 'tours.businessPanelDashboard.stats.content', placement: 'auto', disableBeacon: true },
    { target: '[data-tour-id="business-panel-dashboard--quick-actions"]', titleKey: 'tours.businessPanelDashboard.quickActions.title', contentKey: 'tours.businessPanelDashboard.quickActions.content', placement: 'left', disableBeacon: true },
    { target: '[data-tour-id="business-panel-dashboard--recent-activity"]', titleKey: 'tours.businessPanelDashboard.recentActivity.title', contentKey: 'tours.businessPanelDashboard.recentActivity.content', placement: 'top', disableBeacon: true },
