...
export const courseLearnTour: TourConfig = {
  ...
  steps: [
    ...
    { target: '[data-tour-id="course-learn--notes-tab"]', titleKey: 'tours.courseLearn.notes.title', contentKey: 'tours.courseLearn.notes.content', placement: 'right', disableBeacon: true },
    { target: '[data-tour-id="course-learn--tabs"]', titleKey: 'tours.courseLearn.tabs.title', contentKey: 'tours.courseLearn.tabs.content', placement: 'bottom', disableBeacon: true },
    { target: '[data-tour-id="course-learn--video-player"]', titleKey: 'tours.courseLearn.video.title', contentKey: 'tours.courseLearn.video.content', placement: 'bottom', disableBeacon: true, optional: true },
    { target: '[data-tour-id="course-learn--lesson-resources"]', titleKey: 'tours.courseLearn.resources.title', contentKey: 'tours.courseLearn.resources.content', placement: 'top', disableBeacon: true, optional: true },
    { target: '[data-tour-id="course-learn--tab-activities"]', titleKey: 'tours.courseLearn.activitiesTab.title', contentKey: 'tours.courseLearn.activitiesTab.content', placement: 'bottom', disableBeacon: true },
    { target: '[data-tour-id="course-learn--activities-content"]', titleKey: 'tours.courseLearn.activities.title', contentKey: 'tours.courseLearn.activities.content', placement: 'right', disableBeacon: true, optional: true },
    { target: '[data-tour-id="course-learn--tab-questions"]', titleKey: 'tours.courseLearn.questionsTab.title', contentKey: 'tours.courseLearn.questionsTab.content', placement: 'bottom', disableBeacon: true },
    { target: '[data-tour-id="course-learn--questions-header"]', titleKey: 'tours.courseLearn.questions.title', contentKey: 'tours.courseLearn.questions.content', placement: 'right', disableBeacon: true, optional: true },
