...
export const courseLearnTour: TourConfig = {
  ...
  steps: [
    ...
    { target: '[data-tour-id="course-learn--activities-header"]', titleKey: 'tours.courseLearn.activities.title', contentKey: 'tours.courseLearn.activities.content', placement: 'right', disableBeacon: true, optional: true },
