...
export function useNoteEditor(orgSlug: string, noteId: string) {
  ...
  // Todos los apuntes son editables. Al editar un apunte generado (auto-nota o
  // compendio) el servidor lo marca como is_user_edited para que el worker y la
  // recomposición en vivo del compendio respeten la versión del usuario.
  // El compendio abierto por primera vez muestra la vista viva; al editarlo se
  // congela esa versión.
