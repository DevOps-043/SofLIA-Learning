...
export function CatalogCourseCard({
  ...
  const isAlreadyPurchased = hierarchyCourses.some(item => item.course_id === course.id)
  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex-1 flex flex-col">
        <p className="text-[10px] font-bold uppercase tracking-[0.2em] mb-2" style={{ color: colors.accent }}>
          {course.category}
        </p>
