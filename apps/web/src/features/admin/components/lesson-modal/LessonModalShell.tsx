        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex min-h-[100dvh] items-end justify-center p-0 sm:items-center sm:p-4">
            <motion.div
              ...
              className="relative flex h-[100dvh] w-full flex-col overflow-hidden rounded-none border border-gray-200 bg-white shadow-2xl dark:border-gray-500/30 dark:bg-carbon-800 sm:h-auto sm:max-h-[90vh] sm:max-w-4xl sm:rounded-2xl"
