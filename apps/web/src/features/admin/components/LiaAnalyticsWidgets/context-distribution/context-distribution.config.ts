export const CONTEXT_COLORS: Record<string, string> = {
  ...
  community: 'var(--color-error)',
  news: 'var(--color-info, var(--color-accent))',
...
export const CONTEXT_LABEL_KEYS: Record<string, string> = {
  ...
  community: 'liaAnalyticsPage.contextDistribution.contexts.community',
  news: 'liaAnalyticsPage.contextDistribution.contexts.news',
}
