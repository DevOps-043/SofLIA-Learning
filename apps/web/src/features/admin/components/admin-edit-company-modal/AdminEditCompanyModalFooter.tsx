...
export function AdminEditCompanyModalFooter(props: {
  ...
  return (
    <div className="flex items-center justify-end gap-3 border-t border-white/5 bg-[#1E2329] p-6 shrink-0">
