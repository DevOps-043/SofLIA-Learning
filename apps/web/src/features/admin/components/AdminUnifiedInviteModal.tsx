...
import { useAdminUnifiedInviteModalLogic } from '@/features/admin/hooks/useAdminUnifiedInviteModalLogic'
...
export function AdminUnifiedInviteModal({
  ...
  const {
    ...
    handleCreateAnother,
    getStatusConfig,
  } = useAdminUnifiedInviteModalLogic({ isOpen, onClose, onInviteSent, onLinkCreated, organizationId })
