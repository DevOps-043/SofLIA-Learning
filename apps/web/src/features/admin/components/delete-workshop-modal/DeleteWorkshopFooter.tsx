...
export function DeleteWorkshopFooter(props: DeleteWorkshopFooterProps) {
  ...
  return (
    <>
      {props.deleteError ? <div className="mb-4 rounded-xl border p-4" style={{ backgroundColor: `color-mix(in srgb, ${theme.dangerColor} 7.8%, transparent)`, borderColor: `color-mix(in srgb, ${theme.dangerColor} 14.9%, transparent)` }}><p className="text-sm" style={{ color: theme.dangerColor }}>{props.deleteError}</p></div> : null}
