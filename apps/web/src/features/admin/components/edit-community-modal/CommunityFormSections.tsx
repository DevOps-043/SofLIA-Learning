    ...
    <div className="space-y-2">
      ...
      <div className="relative group">
        ...
        <input
          ...
          className={`w-full ${icon ? 'pl-12' : 'pl-4'} pr-4 py-3.5 rounded-xl bg-[#0A0D12] text-white placeholder-gray-500 border transition-all duration-300 outline-none ${error ? 'border-red-500 focus:border-red-500 focus:ring-2 focus:ring-red-500/20' : 'border-white/10 focus:border-[#00D4B3] focus:ring-2 focus:ring-[#00D4B3]/20 hover:border-white/20'
            }`}
        />
        {isFocused && !error && (
    ...
    <div className="space-y-2">
      ...
      <div className="relative">
        <textarea name={name} value={value} onChange={onChange} placeholder={placeholder} required={required} rows={rows}
          onFocus={() => setIsFocused(true)} onBlur={() => setIsFocused(false)}
          className={`w-full px-4 py-3.5 rounded-xl bg-[#0A0D12] text-white placeholder-gray-500 border transition-all duration-300 outline-none resize-none ${error ? 'border-red-500 focus:border-red-500' : 'border-white/10 focus:border-[#00D4B3] focus:ring-2 focus:ring-[#00D4B3]/20 hover:border-white/20'
            }`}
        />
        {isFocused && !error && (
          <motion.div className="absolute inset-0 rounded-xl pointer-events-none"
