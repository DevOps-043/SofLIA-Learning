...
export function AdminUsersHeroActions(props: AdminUsersHeroActionsProps) {
  ...
  return (
    <div className="flex flex-wrap items-center justify-start gap-3 lg:justify-end">
      ...
      <motion.button type="button" onClick={onAddClick} className="flex items-center gap-2 rounded-xl px-6 py-2.5 text-sm font-bold transition-all" style={{ backgroundColor: theme.primaryColor, boxShadow: `0 8px 30px color-mix(in srgb, ${theme.primaryColor} 25.1%, transparent)`, color: theme.onPrimaryColor }} whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
