    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          className="relative flex h-full w-full max-w-3xl flex-col overflow-hidden bg-transparent shadow-2xl sm:h-[min(calc(var(--soflia-viewport-height)-3rem),750px)] sm:max-h-[750px] sm:rounded-[2.5rem]"
