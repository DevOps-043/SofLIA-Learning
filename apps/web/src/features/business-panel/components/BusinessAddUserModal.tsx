      ...
      <div className="fixed inset-0 flex items-center justify-center p-0 sm:p-4 isolate" style={{ zIndex: 99999 }}>
        ...
        >
          <div className="flex flex-col h-full overflow-hidden border" style={{ backgroundColor: surfaceColor, borderColor }}>
            <div className="relative shrink-0 pt-6 pb-4 px-6 lg:px-12 border-b" style={{ borderColor }}>
            ...
            <form onSubmit={handleSubmit} className="flex-1 flex flex-col overflow-hidden">
               <div className="flex-1 overflow-y-auto pt-6 pb-12 px-6 lg:px-12 space-y-8" style={{ scrollbarWidth: 'thin', scrollbarColor: `${borderColor} transparent` }}>
                  {error ? (
