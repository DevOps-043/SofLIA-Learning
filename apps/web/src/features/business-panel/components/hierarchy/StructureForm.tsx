                        ...
                        <div className="flex min-h-[400px]">
                            ...
                            <div className="hidden md:flex w-64 p-8 flex-col items-center justify-center space-y-6 border-r border-neutral-100 dark:border-white/5 bg-neutral-50/50 dark:bg-black/10">
                                ...
                                <div className="text-center space-y-2">
                                    <div className="flex items-center justify-center gap-2">
                                        ...
                                        <span className="text-[10px] font-black uppercase tracking-widest text-[#00D4B3]">{t('hierarchy.structureForm.sideTitle')}</span>
                                    </div>
                            ...
                            <div className="flex-1 p-8 flex flex-col">
                                <div className="flex items-center justify-between mb-8">
                                    <h3 className="text-xl font-black text-[#0A2540] dark:text-white tracking-tight italic">{t('hierarchy.structureForm.title')}</h3>
