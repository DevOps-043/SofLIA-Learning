...
export function NodeManagerCard({ state, t }: NodeDashboardCommonProps) {
  ...
  return (
    <div className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-white/5 bg-carbon-800 p-6">
