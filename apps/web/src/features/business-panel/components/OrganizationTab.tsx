          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex-1">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2 font-medium">
                Recomendado: 512x512px. Formato PNG o SVG para mejores resultados.
              </p>
              <button
                type="button"
                onClick={uploadLogo}
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-3 rounded-xl border transition-all duration-300 bg-white dark:bg-white/5 border-gray-200 dark:border-white/10 hover:border-blue-500/30">
              ...
              <motion.button
                ...
                style={{ backgroundColor: formData.show_navbar_name ? '#3b82f6' : 'rgba(156, 163, 175, 0.3)' }}
              >
                <motion.span
                  layout
                  transition={{ type: 'spring', stiffness: 500, damping: 30 }}
                  className="inline-block h-4 w-4 transform rounded-full bg-white shadow-sm ml-1"
                  style={{ translateX: formData.show_navbar_name ? 20 : 0 }}
                />
              </motion.button>
            </div>
            ...
            <div className="group/input">
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  placeholder="10"
                />
                <span className="text-sm text-gray-500 dark:text-gray-400 px-3 py-2 rounded-lg bg-gray-100 dark:bg-white/5">
                  usuarios
                </span>
              </div>
            </div>
