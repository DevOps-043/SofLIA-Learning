/**
 * VARIANTE GEMINI del prompt de analitica del empleado. TEXTO ORIGINAL, CONGELADO.
 *
 * No se toca para mejorar OpenAI: para eso existe `prompt.openai.ts`.
 */
import type { BusinessUserAnalyticsLocale } from '../../../types/business-user-analytics.types'

export function buildSystemPromptForGoogle(locale: BusinessUserAnalyticsLocale): string {
