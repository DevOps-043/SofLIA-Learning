/**
 * VARIANTE GEMINI del prompt de insights de informes. TEXTO ORIGINAL, CONGELADO.
 *
...
export function buildSystemPromptForGoogle(locale: ReportsAnalyticsLocale): string {
