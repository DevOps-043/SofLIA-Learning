...
export function buildSystemPrompt(locale: ReportsAnalyticsLocale): string {
  ...
  return [
    ...
    'Act as a complete analytics agent: choose the most relevant patterns across learning, activities, assessments, SofLIA, planning, segments, hierarchy, and course risk.',
