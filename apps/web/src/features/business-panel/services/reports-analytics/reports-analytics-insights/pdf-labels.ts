...
const ES = {
  ...
  notesCreated: 'notas creadas', planner: 'Planificacion', quality: 'Calidad',
...
const EN = {
  ...
  notesCreated: 'notes created', planner: 'Planning', quality: 'Quality',
...
const PT = {
  ...
  notesCreated: 'notas criadas', planner: 'Planejamento', quality: 'Qualidade',
