export const fallbackTextEn = {
  learningTitle: 'Learning and completion', adoptionTitle: 'AI and notes adoption', qualityTitle: 'Response quality',
  metricProgress: 'Progress and closure', metricSoflia: 'SofLIA adoption', metricQuality: 'Operational quality', actionPlanTitle: 'Suggested action plan',
  noHierarchy: 'There is not enough hierarchy data to compare regions, zones, or areas.', noRiskCourse: 'No course shows critical risk signals in the filtered period.', noSegment: 'There are not enough segments to compare quality.',
