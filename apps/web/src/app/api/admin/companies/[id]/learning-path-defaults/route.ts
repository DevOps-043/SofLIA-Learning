...
export async function GET(_request: NextRequest, { params }: RouteParams) {
  ...
  try {
    ...
    const nodes = await LearningPathDefaultsService.listHierarchyNodeOptions(organizationId)
    const rules = await LearningPathDefaultsService.listDefaultRules(organizationId, { nodes })
