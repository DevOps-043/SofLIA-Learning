...
import type { LiaChatProcessingBody } from './types'
import { asRecord, readNumber } from './parsing'
...
export function buildScreenResolution(enrichedMetadata: Record<string, unknown> | undefined) {
