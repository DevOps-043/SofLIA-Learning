...
export interface AnalysisSummary {
  adoption: { score: number; level: string; description: string; totalQuestions: number }
  knowledge: { score: number; correct: number; total: number; level: string; description: string }
}
