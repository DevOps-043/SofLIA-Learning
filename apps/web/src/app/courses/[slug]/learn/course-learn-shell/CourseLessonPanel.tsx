...
export function CourseLessonPanel({ logic, shell }: { logic: LearnPageLogicResult; shell: CourseLearnShellState }) {
  return (
    <div data-tour-id="course-learn--lesson-panel" className={`mx-0 my-0 flex flex-1 flex-col overflow-hidden rounded-lg border-2 border-gray-200 bg-white md:mx-2 md:my-2 dark:border-white/10 dark:bg-gray-800 ${shell.disableHeavyEffects ? '' : 'backdrop-blur-sm shadow-xl'}` }>
